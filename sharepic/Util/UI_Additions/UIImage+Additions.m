 ...
 *  @return UIImage
 */
+ (UIImage *)imageByDevice:(NSString *)imageName{
    
    UIImage *img;
    
    // Pick image for device
    if (DEVICE_IS_IPAD){
        img = [UIImage imageNamed: [NSString stringWithFormat:@"%@-iPad",imageName]];
    }else{
        
        int deviceHeight = (int)[UIScreen mainScreen].bounds.size.height;
        
        img = [UIImage imageNamed: [NSString stringWithFormat:@"%@-%dh",imageName,deviceHeight] ];
    }
...
/**
 *  Get Image By Device and Orientation
 *
 *  @param imageName image name
 *
 *  @return UIImage
 */
+ (UIImage *)imageByDeviceOrientation:(NSString *)imageName{
    ...
    if (DEVICE_IS_IPAD){
        ...
        if (DEVICE_ORIENTATION_LANDSCAPE) {
            img = [UIImage imageNamed: [NSString stringWithFormat:@"%@-iPad~land",imageName]];
        ...
        if (DEVICE_ORIENTATION_LANDSCAPE) {
            img = [UIImage imageNamed: [NSString stringWithFormat:@"%@-%dw",imageName,deviceHeight] ];
