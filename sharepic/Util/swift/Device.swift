...
public enum Device {
    ...
    func IS_3_5_INCHES() -> Bool {
        return isPhone && Device.isSize(.inches_3_5)
    }
    
    func IS_3_5_INCHES_OR_LARGER() -> Bool {
        return isPhone && Device.isSizeOrLarger(.inches_3_5)
    }
    
    func IS_3_5_INCHES_OR_SMALLER() -> Bool {
        return isPhone && Device.isSizeOrSmaller(.inches_3_5)
    }
    
    // MARK: 4 Inch Checks
    
    func IS_4_INCHES() -> Bool {
        return isPhone && Device.isSize(.inches_4)
    }
    
    func IS_4_INCHES_OR_LARGER() -> Bool {
        return isPhone && Device.isSizeOrLarger(.inches_4)
    }
    
    func IS_4_INCHES_OR_SMALLER() -> Bool {
        return isPhone && Device.isSizeOrSmaller(.inches_4)
    }
    
    // MARK: 4.7 Inch Checks
    
    func IS_4_7_INCHES() -> Bool {
        return isPhone && Device.isSize(.inches_4_7)
    }
    
    func IS_4_7_INCHES_OR_LARGER() -> Bool {
        return isPhone && Device.isSizeOrLarger(.inches_4_7)
    }
    ...
    func IS_5_5_INCHES() -> Bool {
        return isPhone && Device.isSize(.inches_5_5)
    }
    
    func IS_5_5_INCHES_OR_LARGER() -> Bool {
        return isPhone && Device.isSizeOrLarger(.inches_5_5)
    }
    
    func IS_5_5_INCHES_OR_SMALLER() -> Bool {
        return isPhone && Device.isSizeOrLarger(.inches_5_5)
    }
